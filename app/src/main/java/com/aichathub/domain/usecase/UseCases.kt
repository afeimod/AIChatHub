...
class GetAPIKeysUseCase @Inject constructor(
    ...
    operator fun invoke(): kotlinx.coroutines.flow.Flow<List<APIKeyInfo>> {
        return apiKeyRepository.getAllAPIKeys()
    }

    fun byPlatform(platform: AIPlatform): kotlinx.coroutines.flow.Flow<List<APIKeyInfo>> {
...
class GetSettingsUseCase @Inject constructor(
    ...
    operator fun invoke(): kotlinx.coroutines.flow.Flow<AppSettings> {
